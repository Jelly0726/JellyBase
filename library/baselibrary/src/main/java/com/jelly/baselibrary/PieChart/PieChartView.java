package com.jelly.baselibrary.PieChart;
...
public class PieChartView extends View {
    ...
    private void initAtrrs(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.PieChartView, defStyleAttr, 0);
        pieName = array.getString(R.styleable.PieChartView_pieChartName);
        nameSize = array.getDimensionPixelOffset(R.styleable.PieChartView_pieChartNameSize, dp2px(16));
        nameColor = array.getColor(R.styleable.PieChartView_pieChartNameColor, Color.BLACK);
        nameOrientation = array.getInt(R.styleable.PieChartView_pieChartNameOrientation, HORIZONTAL);
        textSize = array.getDimensionPixelOffset(R.styleable.PieChartView_pieChartTextSize, dp2px(16));
        textColor = array.getColor(R.styleable.PieChartView_pieChartTextColor, Color.BLACK);
        textOrientation = array.getInt(R.styleable.PieChartView_pieChartTextOrientation, PiePath);
        pieChartWidth = array.getDimensionPixelOffset(R.styleable.PieChartView_pieChartWidth, 0);
        mRadius = array.getDimensionPixelOffset(R.styleable.PieChartView_pieChartRadius, 0);
        alphaWidth = array.getDimensionPixelOffset(R.styleable.PieChartView_alphaWidth, 0);
        alphaPieColor = array.getColor(R.styleable.PieChartView_alphaPieColor, Color.WHITE);
        alphaPieTran = array.getInteger(R.styleable.PieChartView_alphaPieTran, 80);
        inCricleColor = array.getColor(R.styleable.PieChartView_inCricleColor, Color.TRANSPARENT);
        isAnimation = array.getBoolean(R.styleable.PieChartView_isAnimation, true);
        isTouchFlag = array.getBoolean(R.styleable.PieChartView_isTouchFlag, true);
        drawStartAngle = array.getInteger(R.styleable.PieChartView_startAngle, 0);
        segmentAngle = array.getFloat(R.styleable.PieChartView_segmentAngle, 0);
        animaDuration = (long)array.getInteger(R.styleable.PieChartView_animaDuration, 2000);
        array.recycle();
    }
     ...
     * 设置是否开启动画，默认开启
     */
    public PieChartView setIsAnimated(boolean isAnimation) {
     ...
     * 设置是否开启触摸点击 默认开启
     */
    public PieChartView setIsTouchFlag(boolean isTouchFlag) {
     ...
     * 设置动画类型
     */
    public PieChartView setTimeInterpolator(TimeInterpolator timeInterpolator) {
     ...
     * 设置中间文字颜色
     */
    public PieChartView setNameColor(int color) {
     ...
     * 设置中间文字大小
     */
    public PieChartView setNameSize(int size) {
     ...
     * 设置中间文字方向默认水平方向
     */
    public PieChartView setNameOrientation(int orientation) {
     ...
     * 设置内容文字颜色
     */
    public PieChartView setTextColor(int color) {
     ...
     * 设置内容文字大小
     */
    public PieChartView setTextSize(int size) {
     ...
     * 设置内容文字方向
     */
    public PieChartView setTextOrientation(int orientation) {
     ...
     * 设置起始角度
     */
    public PieChartView setStartAngle(float startAngle) {
     ...
     * 动画
     */
    public PieChartView startAnimator() {
        initAnimator();
        return this;
    }
}
