 ...
 * 通过银行的Bin号 来获取 银行名称
 * @author 一介草民
 *https://ccdcapi.alipay.com/validateAndCacheCardInfo.json?_input_charset=utf-8&cardNo=6236681930004992390&cardBinCheck=true
 */
public class BankUtil {
     ...
     * @return
     */
    public static String getBankCardID(@NonNull String bankcardid){
