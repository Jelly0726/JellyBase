package com.jelly.baselibrary.screenCapture;
...
//                    }
                    //保存到系统相册
                    MediaStore.Images.Media.insertImage(getContext().getApplicationContext().getContentResolver(), bitmap, "title", "description");
