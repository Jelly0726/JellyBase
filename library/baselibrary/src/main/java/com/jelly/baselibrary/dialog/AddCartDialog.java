...
public class AddCartDialog extends AbsBaseCircleDialog implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.cancel_img) {
            ...
            dismiss();
        } else if (id == R.id.increase_goods_Num) {//加
            doIncrease(goodsNum);
        } else if (id == R.id.reduce_goodsNum) {//减
            doDecrease(goodsNum);
        } else if (id == R.id.goods_Num) {//修改
            showDialog(goodsNum);
        }
    }
    ...
    private void showDialog(final View showCountView) {
        ...
        View view= LayoutInflater.from(getContext()).inflate(R.layout.addcart_dialog_change_num,null);
        ...
        dialog.setOnShowListener(new DialogInterface.OnShowListener() {
            ...
            public void onShow(DialogInterface dialog) {
                showKeyboard(getContext(),showCountView);
            }
        });
...
//        int count = good.getCount();
    ...
    private void hideKeyboard(Context mcontext,ViewGroup view){
        view.requestFocus();
    ...
    private void showKeyboard(Context mcontext,View view){
        InputMethodManager im= (InputMethodManager) mcontext.getSystemService(Context.INPUT_METHOD_SERVICE);
