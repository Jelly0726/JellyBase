package com.jelly.baselibrary.sms;
...
public class SmsReceiver extends BroadcastReceiver {
    ...
    public SmsReceiver() {
        LogUtils.i("yjj", "new SmsReceiver");
    }
    @Override
    public void onReceive(final Context context, Intent intent) {
        LogUtils.i(TAG, "jie shou dao");
        Cursor cursor = null;
        try {
            if (SMS_RECEIVED.equals(intent.getAction())) {
                LogUtils.d(TAG, "sms received!");
                ...
                if (bundle != null) {
                    ...
                    if (messages.length > 0) {
                        ...
                        Toast.makeText(context, smsToast, Toast.LENGTH_LONG)
                                .show();
                        LogUtils.d(TAG, "message from: " + sender + ", message body: " + content
                        ...
                        LogUtils.i(TAG, "m cursor count is " + cursor.getCount());
                        LogUtils.i(TAG, "m first is " + cursor.moveToFirst());
                    }
                }else {
                    cursor = context.getContentResolver().query(Uri.parse("content://sms"),
                            new String[]{"_id", "address", "read", "body", "date"}, "read = ? ",
