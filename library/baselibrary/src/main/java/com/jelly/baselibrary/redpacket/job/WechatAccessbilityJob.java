...
import com.jelly.baselibrary.redpacket.util.AccessibilityHelper;
import com.jelly.baselibrary.redpacket.util.NotifyHelper;
    ...
    private void handleLuckyMoneyReceive() {
        ...
        if(targetNode != null) {
            ...
            if(sDelayTime != 0) {
                ...
                AccessibilityHelper.performClick(n);
                int wechatSum = AppPrefs.getInt(getContext(), Config.KEY_WECHAT_SUM);
                wechatSum++;
                AppPrefs.putInt(getContext(), Config.KEY_WECHAT_SUM, wechatSum);
            }
        }
    }
