package com.jelly.baselibrary.view
...
/**
 * 验证码输入框
 * 6个TextView，上面覆盖透明EditText接收输入事件。
 */
...
class VerificationCodeView @JvmOverloads constructor(
    ...
    private fun setTextViews() {
        ...
        codes.size.let {
            ...
            when (it) {
                0 -> tvFirst.setBackgroundResource(R.drawable.ver_code_bg_text_checked)
                1 -> tvSecond.setBackgroundResource(R.drawable.ver_code_bg_text_checked)
                2 -> tvThird.setBackgroundResource(R.drawable.ver_code_bg_text_checked)
                3 -> tvFourth.setBackgroundResource(R.drawable.ver_code_bg_text_checked)
                4 -> tvFifth.setBackgroundResource(R.drawable.ver_code_bg_text_checked)
                5 -> tvSixth.setBackgroundResource(R.drawable.ver_code_bg_text_checked)
            }
        }
    }
    ...
    private fun setDefaultViews() {
        ...
        tvFifth.text = ""
        tvSixth.text = ""
        tvFirst.setBackgroundResource(R.drawable.ver_code_bg_text_normal)
        tvSecond.setBackgroundResource(R.drawable.ver_code_bg_text_normal)
        tvThird.setBackgroundResource(R.drawable.ver_code_bg_text_normal)
        tvFourth.setBackgroundResource(R.drawable.ver_code_bg_text_normal)
        tvFifth.setBackgroundResource(R.drawable.ver_code_bg_text_normal)
        tvSixth.setBackgroundResource(R.drawable.ver_code_bg_text_normal)
    }
