package com.jelly.baselibrary.nativeUtil;

/**
 * 通过控制台命令，生成对应的.h文件
 * 先 cd app/src/main 这个时候先到指定的main路径下 执行javah -d jni -classpath 自己编译后的class文件的绝对路径
 * 例：javah -d jni -classpath f:/Jelly/JellyBase/app/build/intermediates/classes/debug com.jelly.baselibrary.nativeUtil.NativeUtils （注意debug后的空格）
