...
public class MyJzvdStd extends JzvdStd {
    private OnVedioPlayListenter onVedioPlayListenter;
    ...
    public void startVideo() {
        super.startVideo();
        if (onVedioPlayListenter!=null){
            onVedioPlayListenter.onStar();
        }
    ...
    public void onError(int what, int extra) {
        ...
        if (onVedioPlayListenter!=null){
            onVedioPlayListenter.onError(what,extra);
        }
    }

    public OnVedioPlayListenter getOnVedioPlayListenter() {
        return onVedioPlayListenter;
    }

    public void setOnVedioPlayListenter(OnVedioPlayListenter onVedioPlayListenter) {
        this.onVedioPlayListenter = onVedioPlayListenter;
    }
    //监听视频播放
    public interface OnVedioPlayListenter {
        //开始播放
        void onStar();
        //播放完成
        void onFinish();
