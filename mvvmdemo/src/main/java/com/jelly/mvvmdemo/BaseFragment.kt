...
//保证onFragmentVisibleChange()的回调发生在rootView创建完成之后，以便支持ui操作
        LogUtils.i("SSSS", "onViewCreated=====$this  rootView=$rootView")
        if (rootView == null) {
            rootView = view
        }
        super.onViewCreated(
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        LogUtils.i("SSSS", "onActivityCreated=====$this  rootView=$rootView")
    ...
    override fun onDestroy() {
        super.onDestroy()
        initVariable()
        LogUtils.i("SSSS", "onDestroy=====$this")
    }
