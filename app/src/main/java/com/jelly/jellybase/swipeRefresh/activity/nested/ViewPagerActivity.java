...
import com.jelly.jellybase.swipeRefresh.fragment.MenuFragment;
...
public class ViewPagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.xswipe_menu_pager_activity);
    ...
    private ViewPager.SimpleOnPageChangeListener mPageChangeListener = new ViewPager.SimpleOnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            switch (position) {
                case 0: {
                    mViewPager.setBackgroundColor(ContextCompat.getColor(ViewPagerActivity.this, R.color.xswipe_colorAccent));
                    break;
                }
                case 1: {
                    mViewPager.setBackgroundColor(ContextCompat.getColor(ViewPagerActivity.this, R.color.xswipe_colorPrimary));
                    break;
                }
                case 2: {
                    mViewPager.setBackgroundColor(ContextCompat.getColor(ViewPagerActivity.this, R.color.xswipe_green_normal));
                    break;
                }
            }
        }
