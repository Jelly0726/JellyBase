 ...
 */
package com.jelly.jellybase.swipeRefresh.activity.header;
...
public class HeaderViewActivity extends AppCompatActivity implements OnItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.xswipe_scroll_activity);
        ...
        // HeaderView。
        View headerView = getLayoutInflater().inflate(R.layout.xswipe_header, recyclerView, false);
        ...
        // FooterView。
        View footerView = getLayoutInflater().inflate(R.layout.xswipe_footer, recyclerView, false);
