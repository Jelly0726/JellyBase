...
public abstract class BaseDragActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView.setOnItemMenuClickListener(mMenuItemClickListener); // Item的Menu点击。
    ...
    private OnItemStateChangedListener mOnItemStateChangedListener = new OnItemStateChangedListener() {
        ...
        public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
            if (actionState == OnItemStateChangedListener.ACTION_STATE_DRAG) {
                ...
                viewHolder.itemView.setBackgroundColor(ContextCompat.getColor(BaseDragActivity.this,
                        R.color.xswipe_white_pressed));
                ...
                // 在手松开的时候还原背景。
                ViewCompat.setBackground(viewHolder.itemView, ContextCompat.getDrawable(BaseDragActivity.this, R.drawable.xswipe_select_white));
            }
        }
    };
