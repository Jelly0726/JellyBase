...
import com.jelly.jellybase.databinding.EncryptActivityBinding;

public class EncryptActivity extends BaseActivity<EncryptActivityBinding> implements View.OnClickListener {
...
//        DebugLog.i("公钥=\n"+RSAKey[0]);
//        DebugLog.i("私钥=\n"+RSAKey[1]);
        getViewBinding().btnSha1OfApk.setOnClickListener(this);
        getViewBinding().btnApk.setOnClickListener(this);
        getViewBinding().btnNativeEncode.setOnClickListener(this);
        getViewBinding().btnJavaEncode.setOnClickListener(this);
        getViewBinding().btnNativeDecode.setOnClickListener(this);
        getViewBinding().btnJavaDecode.setOnClickListener(this);
        getViewBinding().btnJavaSign.setOnClickListener(this);
        getViewBinding().btnNativeSign.setOnClickListener(this);
        getViewBinding().btnMd5Sign.setOnClickListener(this);
        getViewBinding().btnAESSign.setOnClickListener(this);
        getViewBinding().btnAESsSign.setOnClickListener(this);
        getViewBinding().btnAESKey.setOnClickListener(this);
        getViewBinding().btnAESsKey.setOnClickListener(this);
        getViewBinding().btnRSASign.setOnClickListener(this);
        getViewBinding().btnRSAsSign.setOnClickListener(this);
        getViewBinding().btnRSAaSign.setOnClickListener(this);
        getViewBinding().btnRSAdSign.setOnClickListener(this);
        getViewBinding().btnCopySign.setOnClickListener(this);
        getViewBinding().btnPastSign.setOnClickListener(this);
        getViewBinding().btnCreateRSA.setOnClickListener(this);
        getViewBinding().btnRead.setOnClickListener(this);
        //Edittext通知父控件自己处理自己的滑动事件
        getViewBinding().inputOri.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                if (v.getId() == R.id.input_ori && canVerticalScroll(getViewBinding().inputOri)) {
    ...
    public void onClick(View v) {
        String ori = getViewBinding().inputOri.getText().toString().trim();
        String result = "";
        switch (v.getId()) {
...
//                result = "RSA公钥解密->" + SafetyUtil.getInstance().decodeByRSAPubKey(BaseApplication.getInstance(),ori,SafetyUtil.PUBLIC_KEY);
            ...
            case R.id.btn_copy_sign:
                String ssss = getViewBinding().textResult.getText().toString();
            ...
            case R.id.btn_past_sign:
                ...
                if (mClipboardManager.hasPrimaryClip()
                    ...
                    getViewBinding().inputOri.setText(text);
                    getViewBinding().inputOri.setSelection(text.length());
                }
                break;
        ...
        getViewBinding().textResult.setText(result);
    }
