...
//        DebugLog.i("公钥=\n"+RSAKey[0]);
//        DebugLog.i("私钥=\n"+RSAKey[1]);
        getBinding().btnSha1OfApk.setOnClickListener(this);
        getBinding().btnApk.setOnClickListener(this);
        getBinding().btnNativeEncode.setOnClickListener(this);
        getBinding().btnJavaEncode.setOnClickListener(this);
        getBinding().btnNativeDecode.setOnClickListener(this);
        getBinding().btnJavaDecode.setOnClickListener(this);
        getBinding().btnJavaSign.setOnClickListener(this);
        getBinding().btnNativeSign.setOnClickListener(this);
        getBinding().btnMd5Sign.setOnClickListener(this);
        getBinding().btnAESSign.setOnClickListener(this);
        getBinding().btnAESsSign.setOnClickListener(this);
        getBinding().btnAESKey.setOnClickListener(this);
        getBinding().btnAESsKey.setOnClickListener(this);
        getBinding().btnRSASign.setOnClickListener(this);
        getBinding().btnRSAsSign.setOnClickListener(this);
        getBinding().btnRSAaSign.setOnClickListener(this);
        getBinding().btnRSAdSign.setOnClickListener(this);
        getBinding().btnCopySign.setOnClickListener(this);
        getBinding().btnPastSign.setOnClickListener(this);
        getBinding().btnCreateRSA.setOnClickListener(this);
        getBinding().btnRead.setOnClickListener(this);
        //Edittext通知父控件自己处理自己的滑动事件
        getBinding().inputOri.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                if (v.getId() == R.id.input_ori && canVerticalScroll(getBinding().inputOri)) {
    ...
    public void onClick(View v) {
        String ori = getBinding().inputOri.getText().toString().trim();
        String result = "";
        switch (v.getId()) {
...
//                result = "RSA公钥解密->" + SafetyUtil.getInstance().decodeByRSAPubKey(BaseApplication.getInstance(),ori,SafetyUtil.PUBLIC_KEY);
            ...
            case R.id.btn_copy_sign:
                String ssss = getBinding().textResult.getText().toString();
            ...
            case R.id.btn_past_sign:
                ...
                if (mClipboardManager.hasPrimaryClip()
                    ...
                    getBinding().inputOri.setText(text);
                    getBinding().inputOri.setSelection(text.length());
                }
                break;
        ...
        getBinding().textResult.setText(result);
    }
