...
public class ProductEvaluateAdapter extends BaseRecyclerAdapter<ProductEvaluateAdapter.ViewHolder> {

    private LayoutInflater mInflater;
    private Context context;
    private List<Product> mList;
    public ProductEvaluateAdapter(Context context, List<Product> mList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType, boolean isItem) {
        final View view = mInflater.inflate(R.layout.productdetails_item_evaluate, parent, false);
