package com.jelly.jellybase.shopcar.adapter;
...
public class ShopcatAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(mcontext, R.layout.shopcat_item_group, null);
        ...
        groupViewHolder.storeName.setOnClickListener(new OnMultiClickListener() {
            @Override
            public void onMultiClick(View v) {
                if(onGroupClickListener!=null){
                    onGroupClickListener.onClick(v,group,groupPosition);
                }
            }
        });
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(mcontext, R.layout.shopcat_item_product, null);
        ...
        if (child != null) {
            ...
            childViewHolder.goodsNames.setText(child.getDesc());
            childViewHolder.goodsPrice.setText(child.getPrice() + "/斤");
            childViewHolder.goodsNum.setText(String.valueOf(child.getCount()));
            childViewHolder.goodsImage.setImageResource(R.drawable.shopcar_cmaz);
            childViewHolder.goodsImage.setOnClickListener(new OnMultiClickListener() {
                @Override
                public void onMultiClick(View v) {
                    if(onChildClickListener!=null){
                        onChildClickListener.onClick(v,child,childPosition);
                    }
                }
            });
    ...
    public OnGroupClickListener getOnGroupClickListener(){return onGroupClickListener;}
    public void setOnGroupClickListener(OnGroupClickListener onGroupClickListener){
        this.onGroupClickListener=onGroupClickListener;
    }
    public OnChildClickListener getOnChildClickListener(){return onChildClickListener;}
    ...
    static class ChildViewHolder {
        ...
        public ChildViewHolder(View view) {
            ...
            goodsNames= (TextView) view.findViewById(R.id.goodsName);
