...
public class GraphValiCodeActivity extends BaseActivity<GraphvalicodeActivityBinding> implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getBinding().butForgetpassToSetCodes.setOnClickListener(this);
        getBinding().ivShowCode.setOnClickListener(this);
    }
    @Override
    ...
    protected void onResume() {
        super.onResume();
        //将验证码用图片的形式显示出来
        getBinding().ivShowCode.setImageBitmap(GraphValiCode.getInstance().createBitmap());
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.but_forgetpass_toSetCodes:
                String phoneCode = getBinding().etPhoneCodes.getText().toString().toLowerCase();
