...
public class CharacteristicOperationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.bluetooth_fragment_characteric_operation, null);
        initView(v);
        return v;
    }
    ...
    public void showData() {
        ...
        if (childList.contains(child)) {
            ...
            View view = LayoutInflater.from(getActivity()).inflate(R.layout.bluetooth_layout_characteric_operation, null);
            ...
            switch (charaProp) {
                case PROPERTY_READ: {
                    View view_add = LayoutInflater.from(getActivity()).inflate(R.layout.bluetooth_layout_characteric_operation_button, null);
                ...
                case PROPERTY_WRITE: {
                    View view_add = LayoutInflater.from(getActivity()).inflate(R.layout.bluetooth_layout_characteric_operation_et, null);
