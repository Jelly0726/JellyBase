...
public class WokTimeDiaLog {
	...
	public void getStarOnClick() {
		Count= AppPrefs.getLong(context.getApplicationContext(),ConfigKey.WORKCONNT,0l);
				...
				task=new TimerTask() {
					...
					public void run() {
						...
						try {
							...
							AppPrefs.putString(context.getApplicationContext(),ConfigKey.WORKTIME,wiatTime);
							AppPrefs.putLong(context.getApplicationContext(),ConfigKey.WORKCONNT,Count);
