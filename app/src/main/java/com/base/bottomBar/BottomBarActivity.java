...
public class BottomBarActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bottombar_demo);
            ...
            public void onItemSelected(final BottomBarItem bottomBarItem, int position) {
                if (position == 0){
                    ...
                    if (mBottomBarLayout.getCurrentItem() == position){
                        ...
                        bottomBarItem.setIconSelectedResourceId(R.drawable.bottombar_loading);//更换成加载图标
                        ...
                        mHandler.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                bottomBarItem.setIconSelectedResourceId(R.drawable.bottombar_home_selected);//更换成首页原来图标
                ...
                bottomItem.setIconSelectedResourceId(R.drawable.bottombar_home_selected);//更换为原来的图标
