...
public class TopBarItem extends LinearLayout {
    ...
    public TopBarItem(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TopBarItem(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        View view = View.inflate(mContext, R.layout.bottombar_top_item, null);
        if (mItemPadding != 0){
            //如果有设置item的padding
