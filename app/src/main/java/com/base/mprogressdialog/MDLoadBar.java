 ...
 * 对勾和叉的加载动画控件
 */
public class MDLoadBar extends View {

    private final static String TAG = MDLoadBar.class.getSimpleName();
    ...
    public MDLoadBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    public MDLoadBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    private void init(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.MDLoadAttr);
        arcColor = typedArray.getColor(R.styleable.MDLoadAttr_MDLoadArcColor, Color.parseColor("#4a90e2"));
        mBorderWidth = typedArray.getDimension(R.styleable.MDLoadAttr_MDLoadBarBorderWidth,
