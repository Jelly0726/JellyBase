...
//				break;
	...
	private void initView() {
		...
		mOffLineChildView = inflater.inflate(R.layout.amap_offlinemap_child, null);
	...
	private void displayDefault() {
		...
		mDownloadImage.setImageResource(R.drawable.amap_offlinearrow_download);
	}
	...
	private void displayWaitingStatus(int completeCode) {
		mDownloadProgress.setVisibility(View.VISIBLE);
		mDownloadImage.setVisibility(View.VISIBLE);
		mDownloadImage.setImageResource(R.drawable.amap_offlinearrow_start);
	...
	private void displyaLoadingStatus(int completeCode) {
		...
		mDownloadImage.setVisibility(View.VISIBLE);
		mDownloadImage.setImageResource(R.drawable.amap_offlinearrow_stop);
