 ...
 * 拍照的Activity
 */
public class ScanerCodeActivity extends Activity implements Callback, OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.zxing_scanercode_activity);
		initIntent();
		initView();
		// 初始化 CameraManager
	...
	private void initIntent() {
		...
		isShowHistory = intent.getBooleanExtra(ZXingUtils.ScanIsShowHistory, false);
	...
	private void photo() {
		...
		startActivityForResult(wrapperIntent, ZXingUtils.ScanPhotosRequestCode);
	}
...
//					analysisImage(photo_path);
	...
	public void onClick(View v) {
		...
		if (id == R.id.mo_scanner_back) {
			...
			// 数据返回
			Intent data = new Intent();
			setResult(ZXingUtils.ScanHistoryResultCode, data);
			this.finish();
		}
	}
}