...
public class BadgeUtils {
    ...
    // 点击通知时打开的 activity
    public static final String BadgeAction =  BaseApplication.getInstance().getPackageName()+".action.BADGE_CLICK";
