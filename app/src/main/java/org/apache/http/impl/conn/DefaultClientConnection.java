...
public class DefaultClientConnection extends SocketHttpClientConnection implements OperatedClientConnection {
    ...
    @Override
    public void sendRequestHeader(cn.jiguang.net.HttpRequest var1) throws HttpException, IOException {
    ...
    @Override
    public void receiveResponseEntity(cn.jiguang.net.HttpResponse var1) throws HttpException, IOException {
